...
"""
MPLC_CUDA2 模块实现了基于 CUDA 加速的多平面光学转换 (MPLC) 优化流程。1
...
def parse_cfg() -> SimpleNamespace:
    ...
    parser.add_argument("--delta_theta_1", type=float, default=2 * math.pi / 15)
    parser.add_argument("--delta_theta_0", type=float, default=10 * (2 * math.pi / 15))
